                ...
                <?php
                    ...
                    if(isset($_SESSION['usuario']))
                    {
                        ...
                        if($_GET['visualizar']==1)
                        {
                            ...
                            echo "&nbsp;&nbsp;&nbsp<a href=\"admin.php?senha=1\">Alterar senha</a>";
                        }
                        if($_GET['clientes']==1)
                        {
                            ...
                            for($i=0; $i<$Linhas; $i++)
                            {
                               $Linha=pg_fetch_array($Resultado);
                                ...
                                echo "<br><br><a href=\"admin.php?adicionar=1&id=$id\">Adicionar como admin</a>";
                                echo "<br><br><a href=\"admin.php?excluir=1&id=$id\">Excluir usuário</a>";
                            }
                        ...
                        if($_GET['excluidos']==1)
                        {
                            ...
                            for($i=0; $i<$Linhas; $i++)
                            {
                               $Linha=pg_fetch_array($Resultado);
                                ...
                                $id=$Linha['id_cliente'];
                                echo "<br><br><a href=\"admin.php?reativar=1&id=$id\">Reativar</a>";
                            }
                        ...
                        if($_GET['admin']==1)
                        {
                            ...
                            for($i=0; $i<$Linhas; $i++)
                            {
                               $Linha=pg_fetch_array($Resultado);
                                ...
                                $id=$Linha['id_cliente'];
                                echo "<br><br><a href=\"admin.php?alterar=1&id=$id\">Alterar informações</a>";
                                echo "<br><br><a href=\"admin.php?remover=1&id=$id\">Remover de admin</a>";
                                echo "<br><br><a href=\"admin.php?excluir=1&id=$id\">Excluir usuário</a>";
                            }
                        ...
                        if($_GET['reativar']==1)
                        {
                            ...
                            $Linhas=pg_affected_rows($Resultado);
                            if($Linhas>0)
                                echo "Reativação realizada com sucesso";
                            else
                                echo "Não foi possível realizar reativação";
                        }
                        if($_GET['remover']==1)
                        {
                            $id=$_GET['id'];
                        ...
                        if($_GET['estoque']==1)
                        {
                            ...
                            echo "<form action=\"admin.php?alterar_estoque=1&id=$id\" method=\"post\">";
